#	21/07/2013 - modified to allow infinite history and coloured syntax
...
#modified from default setting to have infinite history
...
alias la='ls -A'
alias l='ls -CF'
alias gap='. /home/matt/gap3r4p4/bin/gap.sh'
